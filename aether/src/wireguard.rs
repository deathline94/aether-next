...
// Full /24s for scanner sampling (master list + historical).
...
// Master WARP/engage port set (deduped, priority ports first).
pub const WG_PORTS: &[u16] = &[
    2408, 500, 4500, 1701, 854, 859, 864, 878, 880, 890, 891, 894, 903, 908, 928, 934, 939,
